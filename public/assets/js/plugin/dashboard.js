var Dashboard=function () {
    ...
    return {
        init: function () {
            ...
            (),
            function () {
                if (0 !=$("#statistik_keaktifan").length) {
                    var e= {
                        type: "line",
                        data: {
                            labels: ["January",
                    ...
                    ;
                    new Chart($("#statistik_keaktifan"), e)
                }
            }
            (),
            ...
            0 !=$("#m_chart_support_tickets").length && Morris.Donut( {
                ...
                ], labelColor: "#a7a7c2", colors: [mApp.getColor("danger"), mApp.getColor("warning"), mApp.getColor("accent")]
            }
            ),
            0 !=$("#stat_sosial_media").length && Morris.Donut( {
                element: "stat_sosial_media", data: [ {
                ...
                , {
                    label: "Twitter", value: 16
                }
                ], labelColor: "#a7a7c2", colors: [mApp.getColor("danger"), mApp.getColor("warning"), mApp.getColor("accent")]
            }
            ),
            0 !=$("#stat_sosial_media2").length && new Chartist.Pie("#stat_sosial_media2", {
                series: [ {
                    value: 32, className: "custom", meta: {
                        color: mApp.getColor("danger")
                    }
            ...
            (),
            function () {
                if (0 !=$("#chartStatistik").length) {
                    var e=document.getElementById("chartStatistik").getContext("2d"),
                    t=e.createLinearGradient(0, 0, 0, 240);
                    t.addColorStop(0, Chart.helpers.color("#ffefce").alpha(1).rgbString()),
                    t.addColorStop(1, Chart.helpers.color("#ffefce").alpha(.3).rgbString());
                    var a= {
                        ...
                        data: {
                            ...
                            "April"],
                            datasets: [ {
                                label: "Post Masuk", backgroundColor: "#aedffc", borderColor: mApp.getColor("info"), pointBackgroundColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointHoverBackgroundColor: mApp.getColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.2).rgbString(), data: [5, 10, 12, 5, 8, 14, 15, 21, 32, 15, 11, 21, 22, 18, 14, 24, 16, 12, 19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21, 17]
                            }
                            ,
                            {
                                label: "Target Masuk", backgroundColor: "#e8e9f2", borderColor: mApp.getColor("metal"), pointBackgroundColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointHoverBackgroundColor: mApp.getColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.2).rgbString(), data: [20, 10, 18, 15, 32, 18, 15, 22, 8, 6, 12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21, 17]
                            },
                            {
                                label: "Kasus Masuk", backgroundColor: "#fcb5c2", borderColor: mApp.getColor("danger"), pointBackgroundColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointHoverBackgroundColor: mApp.getColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.2).rgbString(), data: [20, 10, 18, 15, 32, 18, 15, 22, 8, 6, 12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21, 17]
                            },
                            {
                                label: "Profil Masuk", backgroundColor: "#d392fc", borderColor: mApp.getColor("brand"), pointBackgroundColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointBorderColor: Chart.helpers.color("#ffffff").alpha(0).rgbString(), pointHoverBackgroundColor: mApp.getColor("danger"), pointHoverBorderColor: Chart.helpers.color("#000000").alpha(.2).rgbString(), data: [20, 10, 18, 15, 32, 18, 15, 22, 8, 6, 12, 13, 10, 18, 14, 24, 16, 12, 19, 21, 16, 14, 24, 21, 13, 15, 27, 29, 21, 11, 14, 19, 21, 17]
                            }
                            ]
                        }
                        ,
            ...
            t(),
            function () {
                if (0 !=$("#m_daterangepicker").length) {
                    var e=$("#m_daterangepicker"),
                    t=moment(),
                    a=moment();
                    e.daterangepicker( {
                        startDate: t, endDate: a, opens: "left", ranges: {
                            Today: [moment(), moment()], Yesterday: [moment().subtract(1, "days"), moment().subtract(1, "days")], "Seminggu Terakhir": [moment().subtract(6, "days"), moment()], "Sebulan Yang Lalu": [moment().subtract(29, "days"), moment()], "Bulan Ini": [moment().startOf("month"), moment().endOf("month")], "Akhir Bulan": [moment().subtract(1, "month").startOf("month"), moment().subtract(1, "month").endOf("month")]
                        }
                    }
                    , r),
                    r(t, a, "")
                ...
                function r(t, a, r) {
                    var o="",
                    n="";
                    a - t < 100 || "Hari ini"==r ? (o="Hari ini:", n=t.format("D MMM")): "Kemarin"==r ? (o="Kemarin:", n=t.format("D MMM")): n=t.format("D MMM") + " - " + a.format("D MMM"), e.find(".m-subheader__daterange-date").html(n), e.find(".m-subheader__daterange-title").html(o)
                }
            }
            (),
