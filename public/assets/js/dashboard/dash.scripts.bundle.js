...
//Float Statistik
var mQuickStatistik = function() {
    var t = $("#quick_statistik"),
        e = $("#quick_statistik_tabs"),
        a = t.find(".m-quick-statistik__content"),
        n = function() {
            ! function() {
                var a = $("#quick_statistik_tabs_messenger");
                if (0 !== a.length) {
                    var n = a.find(".m-messenger__messages"),
                        o = function() {
                            var o = t.outerHeight(!0) - e.outerHeight(!0) - a.find(".m-messenger__form").outerHeight(!0) - 120;
            ...
            function() {
                var t = $("#quick_statistik_tabs_settings");
                if (0 !== t.length) {
                    var a = function() {
                        var a = mUtil.getViewPort().height - e.outerHeight(!0) - 60;
                        t.css("height", a), mApp.initScroller(t, {})
            ...
            function() {
                var t = $("#quick_statistik_tabs_logs");
                if (0 !== t.length) {
                    var a = function() {
                        var a = mUtil.getViewPort().height - e.outerHeight(!0) - 60;
                        t.css("height", a), mApp.initScroller(t, {})
    ...
    return {
        init: function() {
            0 !== t.length && new mOffcanvas("quick_statistik", {
                overlay: !0,
                baseClass: "m-quick-statistik",
                closeBy: "quick_statistik_close",
                toggleBy: "quick_statistik_toggle"
            }).one("afterShow", function() {
                mApp.block(t), setTimeout(function() {
                    mApp.unblock(t), a.removeClass("m--hide"), n()
                }, 1e3)
